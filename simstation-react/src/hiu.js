...
export default function SimStationApp() {
  ...
  return (
    <div className="bg-slate-950 min-h-screen text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      {!activeGame && (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-slate-900/90 backdrop-blur-xl border-t border-white/5 flex justify-around items-center px-6 z-40">
          {[
            { id: 'home', icon: Home },
